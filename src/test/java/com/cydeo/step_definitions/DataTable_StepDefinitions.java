...
public class DataTable_StepDefinitions {
    ...
    public void user_should_see_below_info_in_month_dropdown(List<String> expectedMonth) {
        ...
        //this method will return the List of String giving in dropdowns
        List<String> actualMonth = BrowserUtils.dropdownOptionsAsString(dropdownsPage.monthDropdown);

        Assert.assertEquals("The month are/is not the same!", expectedMonth, actualMonth);
        //Assert will check the size of the list first. If it matching it will check content 1 by 1.
